...
<head>
    ...
    <style>
        .jumbotron {
            background-image: url("../../assets/img/bckround.jpg");
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-white p-3 shadow" style="width:100%">
        <div class="container">
            <a class="navbar-brand">
                <img src="../../assets/img/logo2.jpeg" width="30" height="30" alt="logosmk">
                <span class="align-middle">SMA Muhammadiyah Limbung</span>
            </a>
        ...
        <div class="container text-light">
            <div class="row p-4">
                <div class="col text-center">
                    <h4>CONTACT</h4>
                    <div>
                        <p class="m-2"><i class="fa fa-envelope mr-2"></i>smasmuhammadiyahlimbung1@gmail.com</p>
                        <p class="m-2"><i class="fa fa-phone mr-2"></i>8217959</p>
                        <p class="m-2"><i class="fa fa-fax mr-2"></i>041123900</p>
                    </div>
                    <div>
                        <a href="https://www.instagram.com/smadiyah_limbung/" class="text-light mx-1"><i
                                class="fab fa-instagram fa-2x"></i></a>
                    </div>
                </div>
                <div class="col text-center">
                    <h4>ADDRESS</h4>
                    <p>Jl. Pendidikan, Timpoppo<br>Bajeng, Mata Allo<br>Kab.Gowa<br>Makassar</p>
                </div>
                <div class="col text-center">
                    <h4>NAVIGATE</h4>
